...
class Artificial_Neural_Network:
    ...
    def __init__(self, input_layer_size, hidden_layer_size, output_layer_size):
        ...
        self.weights = [
            2 * np.random.random((self.input_layer_size, self.hidden_layer_size)) - 1, # W1
            2 * np.random.random((self.hidden_layer_size, self.output_layer_size)) - 1 # W2
        ]
